...
import com.leanhtuan.util.Constant;
...
//	            req.setAttribute("alert", alertMsg);
	            ...
	            out.println("alert('User name or Password empty');");
...
//	            req.setAttribute("alert", alertMsg);
	            ...
	            PrintWriter out = resp.getWriter();
	            out.println("<script type=\"text/javascript\">");
	            out.println("alert('User name or Password isn't correct');");
//	            out.println("location='login';");
	            out.println("</script>");
//	            req.getRequestDispatcher("/view/client/view/login.jsp").forward(req, resp);
	            RequestDispatcher rd = req.getRequestDispatcher("/view/client/view/login.jsp");
	            rd.include(req, resp);
	        }
	    }
